 ...
 */
	 ...
	 * Hook jony_wrp_start
	 *
	 * @Hooked jony_wrp_start_cb
	 *  
	 */
	do_action( 'jony_wrp_start' );
	 ...
	 * column start.
	 *
	 * Hook jony_blog_col_start
	 *
	 * @Hooked jony_blog_col_start_cb
	 *  
	 */
	do_action( 'jony_blog_col_start' );
	 ...
	 * column end.
	 *
	 * Hook jony_blog_col_end
	 *
	 * @Hooked jony_blog_col_end_cb
	 *  
	 */
	do_action( 'jony_blog_col_end' );
	 ...
	 *
	 * Hook jony_blog_sidebar
	 *
	 * @Hooked jony_blog_sidebar_cb
	 *  
	 */
	do_action( 'jony_blog_sidebar' );
	 ...
	 * wrapper end with wrapper div, container, row.
 	 *
 	 * Hook jony_wrp_end
 	 * @Hooked  jony_wrp_end_cb
 	 *
 	 */
 	do_action( 'jony_wrp_end' );
