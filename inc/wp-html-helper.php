...
// image default alt
if ( ! function_exists( 'jony_img_default_alt' ) ) {
	function jony_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'jony_img_tag' ) ) {
	function jony_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'jony_anchor_tag' ) ) {
	function jony_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'jony_heading_tag' ) ) {
	function jony_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'jony_paragraph_tag' ) ) {
	function jony_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'jony_other_tag' ) ) {
	function jony_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'jony_button_element ' ) ) {
	function jony_button_element( array $args ) {
