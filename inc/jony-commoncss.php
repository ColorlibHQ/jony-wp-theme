...
// enqueue css
function jony_common_custom_css(){
    
    wp_enqueue_style( 'jony-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= jony_opt( 'jony_theme_color' ) != '#131313' ? jony_opt( 'jony_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= jony_opt( 'jony_book_btn_color' ) != '#131313' ? jony_opt('jony_book_btn_color') : '';
		$bookBtnHoverBgColor     	= jony_opt( 'jony_book_btn_hvr_bg_color' ) != '#131313' ? jony_opt('jony_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = jony_opt( 'jony_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = jony_opt( 'jony_navbar_bg_color' ) != '#082b49' ? jony_opt( 'jony_navbar_bg_color') : '';
		$headerTop_col     		  = jony_opt( 'jony_top_header_color' );

		$headerTopBg      		  = jony_opt( 'jony_top_header_bg_color');
		$headerBg          		  = jony_opt( 'jony_header_bg_color') != '#ffffff' ? jony_opt( 'jony_header_bg_color') : '';
		$menuColor          	  = jony_opt( 'jony_header_menu_color' ) != '#131313' ? jony_opt('jony_header_menu_color') : '';
		$menuHoverColor           = jony_opt( 'jony_header_menu_hover_color' ) != '#808080' ? jony_opt('jony_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = jony_opt( 'jony_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = jony_opt( 'jony_header_drop_menu_bg_color' ) != '#ffffff' ? jony_opt('jony_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = jony_opt( 'jony_dropdown_menu_color' ) != '#131313' ? jony_opt('jony_dropdown_menu_color') : '';
		$dropMenuHovColor         = jony_opt( 'jony_dropdown_menu_hover_color' ) != '#808080' ? jony_opt('jony_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = jony_opt( 'jony_footer_widget_bg_color' );
		$footerwHeadColor   	  = jony_opt('jony_footer_widget_heading_color');
		$footerwTextColor   	  = jony_opt('jony_footer_widget_text_color');
		$footerwanchorcolor 	  = jony_opt('jony_footer_widget_anchor_color') != '#ffffff' ? jony_opt('jony_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = jony_opt('jony_footer_widget_anchor_hover_color') != '#ffffff' ? jony_opt('jony_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = jony_opt('jony_fof_bg_color');
		$foftonecolor			  = jony_opt('jony_fof_textone_color');
		$fofttwocolor			  = jony_opt('jony_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = jony_opt('jony_footer_widget_anchor_color') != '#9e9e9e' ? jony_opt('jony_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .jony_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .jony_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'jony-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'jony_common_custom_css', 50 );