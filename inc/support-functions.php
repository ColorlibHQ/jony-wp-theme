...
function jony_post_cats() {
	...
	if ( $cats ) {
		...
		$categories .= '<ul class="nav"><li><span><i class="fa fm fa-th-list"></i>' . esc_html( 'Catagory :', 'jony' ) . '</span></li>';
...
// Blog categories
function jony_featured_post_cat(){
...
// social media
if ( ! function_exists( 'jony_social' ) ) {
	function jony_social( $args = array() ) {
...
// header cart count
function jony_cart_count( $class = '' ) {

	?>
	<div class="header-wrapicon2 <?php echo esc_attr( $class ); ?>">
		<img src="<?php echo esc_url( JONY_DIR_ASSETS_URI ); ?>img/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="<?php esc_attr_e( 'ICON', 'jony' ); ?>">
...
function jony_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'jony_contact7_form_content', 10, 2 );