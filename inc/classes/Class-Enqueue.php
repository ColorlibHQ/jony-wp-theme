 ...
 */
	...
	class jony_Enqueue{
		...
		public function jony_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'jony_frontend_enqueue_scripts', ) );
		}

		public function jony_frontend_enqueue_scripts( ){
